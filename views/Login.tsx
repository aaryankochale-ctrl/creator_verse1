    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black px-4 transition-colors relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                {/* YouTube - Top Left */}
                <div className="absolute top-20 left-10 opacity-20 dark:opacity-10 transform rotate-12">
                ...
                {/* Instagram - Top Right */}
                <div className="absolute top-32 right-16 opacity-20 dark:opacity-10 transform -rotate-6">
                ...
                <div className="absolute top-1/2 left-8 opacity-15 dark:opacity-10 transform -translate-y-1/2 rotate-[-15deg]">
                ...
                {/* Twitter - Bottom Left */}
                <div className="absolute bottom-24 left-20 opacity-20 dark:opacity-10 transform rotate-[20deg]">
                    <svg className="w-20 h-20" viewBox="0 0 24 24">
                ...
                <div className="absolute bottom-32 right-12 opacity-20 dark:opacity-10 transform rotate-[-10deg]">
                ...
                <div className="absolute top-1/3 right-24 opacity-15 dark:opacity-10 transform rotate-[-20deg]">
                ...
                <div className="absolute bottom-16 left-1/3 opacity-15 dark:opacity-10 transform rotate-[15deg]">
                ...
                <div className="absolute top-16 left-1/2 opacity-10 dark:opacity-10 transform -translate-x-1/2 rotate-[-8deg]">
