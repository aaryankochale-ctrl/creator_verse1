    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black px-4 transition-colors relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-16 left-1/3 opacity-[0.06] dark:opacity-[0.03] transform rotate-[15deg]">
                ...
                <div className="absolute top-16 left-1/2 opacity-[0.05] dark:opacity-[0.02] transform -translate-x-1/2 rotate-[-8deg]">
